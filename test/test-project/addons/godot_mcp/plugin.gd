...
# ============================================================
# Godot MCP Editor Plugin v1.3.7
# ============================================================
...
func _enter_tree() -> void:
	...
	if _stdio_mode:
		_start_stdin_reader()
		_send_stdout({"jsonrpc": "2.0", "id": 0, "result": {"ready": true, "version": "1.3.7"}})
	else:
		_start_tcp_server()
	...
	if _stdio_mode:
		print("[Godot MCP] Plugin v1.3.7 loaded — stdio mode")
	else:
		print("[Godot MCP] Plugin v1.3.7 loaded — TCP on port ", DEFAULT_PORT)
